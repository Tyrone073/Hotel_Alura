package com.tyrone.hotel_alura.prueba;
...
import java.awt.event.MouseMotionAdapter;
		...
		public class Prueba extends JFrame {
			 ...
			 */
			public Prueba() {
				setIconImage(Toolkit.getDefaultToolkit().getImage(Prueba.class.getResource("/imagenes/aH-40px.png")));
				...
				imagenFondo.setIcon(new ImageIcon(Prueba.class.getResource("/imagenes/menu-img.png")));
				...
				imagenLogin.setIcon(new ImageIcon(Prueba.class.getResource("/imagenes/login.png")));
